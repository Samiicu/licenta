...
public class allProcedureActivity extends AppCompatActivity {
    ...
    ArrayAdapter<Procedure> adapterProcedure;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        steps.add("step2");
        steps.add("steps3");
        proceduresList.add(new Procedure("Pro1",DateFormat.getDateInstance(DateFormat.SHORT).format(new Date()), "Procedure 1 descrption", steps));
        proceduresList.add(new Procedure("Pro2", DateFormat.getDateInstance(DateFormat.SHORT).format(new Date()), "Procedure 2 descrption", steps));
        proceduresList.add(new Procedure("Pro3", DateFormat.getDateInstance(DateFormat.SHORT).format(new Date()), "Procedure 3 descrption", steps));
