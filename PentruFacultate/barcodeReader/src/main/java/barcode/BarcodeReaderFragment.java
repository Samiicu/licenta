...
public class BarcodeReaderFragment extends Fragment implements View.OnTouchListener, BarcodeGraphicTracker.BarcodeGraphicTrackerListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(barcodeReader.R.layout.fragment_barcode_reader, container, false);
        permissionStatus = getActivity().getSharedPreferences("permissionStatus", getActivity().MODE_PRIVATE);
        mPreview = view.findViewById(barcodeReader.R.id.preview);
        mGraphicOverlay = view.findViewById(barcodeReader.R.id.graphicOverlay);
        mScanOverlay = view.findViewById(barcodeReader.R.id.scan_overlay);
    ...
    public void onInflate(Context context, AttributeSet attrs, Bundle savedInstanceState) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, barcodeReader.R.styleable.BarcodeReaderFragment);
        autoFocus = a.getBoolean(barcodeReader.R.styleable.BarcodeReaderFragment_auto_focus, true);
        useFlash = a.getBoolean(barcodeReader.R.styleable.BarcodeReaderFragment_use_flash, false);
        a.recycle();
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if (ActivityCompat.checkSelfPermission(getActivity(), Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
            if (ActivityCompat.shouldShowRequestPermissionRationale(getActivity(), Manifest.permission.CAMERA)) {
                ...
                builder.setTitle(getString(barcodeReader.R.string.grant_permission));
                builder.setMessage(getString(barcodeReader.R.string.permission_camera));
                builder.setPositiveButton(barcodeReader.R.string.grant, new DialogInterface.OnClickListener() {
                    @Override
                ...
                builder.setNegativeButton(barcodeReader.R.string.cancel, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.cancel();
                        mListener.onCameraPermissionDenied();
    ...
    private void createCameraSource(final boolean autoFocus, final boolean useFlash) {
        ...
        if (!barcodeDetector.isOperational()) {
            ...
            if (hasLowStorage) {
                Toast.makeText(getActivity(), barcodeReader.R.string.low_storage_error, Toast.LENGTH_LONG).show();
                Log.w(TAG, getString(barcodeReader.R.string.low_storage_error));
            }
        }
